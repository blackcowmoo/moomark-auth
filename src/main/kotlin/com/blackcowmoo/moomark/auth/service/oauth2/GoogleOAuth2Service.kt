...
class GoogleOAuth2Service {
    ...
    fun getToken(code: String): String {
        ...
        val result = restTemplate.postForObject("https://oauth2.googleapis.com/token", parameters, GoogleTokenResponse::class.java)
    ...
    fun parseIdToken(idToken: String): GoogleTokenResult? {
        val body = String(Base64.getDecoder().decode(idToken.split("\\.".toRegex()).toTypedArray()[1]))
        return try {
